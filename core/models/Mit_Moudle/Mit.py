...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("core/models/Mit_Moudle/model_pretrained/segformer_b0_backbone_weights.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("core/models/Mit_Moudle/model_pretrained/segformer_b1_backbone_weights.pth"), strict=False)
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("core/models/Mit_Moudle/model_pretrained/segformer_b2_backbone_weights.pth"), strict=False)
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("core/models/Mit_Moudle/model_pretrained/segformer_b3_backbone_weights.pth"), strict=False)
...
class mit_b4(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("core/models/Mit_Moudle/model_pretrained/segformer_b4_backbone_weights.pth"), strict=False)
...
class mit_b5(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("/home/wuyi/AnsonD/SJT-Net/core/models/Mit_Moudle/model_pretrained/segformer_b5_backbone_weights.pth"), strict=False)
...
class SegFormerHead(nn.Module):
    ...
    def __init__(self, in_channels=[64, 128, 320, 512], embedding_dim=2048, dropout_ratio=0.1):
    ...
    def forward(self, inputs):
        ...
        output = self.linear_fuse(torch.cat([_c4, _c3, _c2, _c1], dim=1))
...
class MIT_Backbone(nn.Module):
    def __init__(self):
        super(MIT_Backbone, self).__init__()
        self.mit = mit_b5(pretrained=True)
        self.fusion = SegFormerHead()
        self.conv = nn.Sequential(nn.Conv2d(2048, 2048, kernel_size=3, stride=2, padding=1),
                                  nn.BatchNorm2d(2048),
                                  nn.ReLU(inplace=True))

    def forward(self, x):
        output = self.fusion(self.mit(x))
