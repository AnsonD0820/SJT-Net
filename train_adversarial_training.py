...
def train(cfg, local_rank, distributed):
    ...
    if cfg.resume:
        ...
        # load checkpoint from train_source
        ...
        # load checkpoint from train_adv
    ...
    for i, ((src_input, src_label, src_name), (tgt_input, _, _)) in enumerate(zip(src_train_loader, tgt_train_loader)):
        ...
        src_pred = F.interpolate(src_pred, size=(512, 512), mode='bilinear', align_corners=True)
        ...
        tgt_pred = F.interpolate(tgt_pred, size=(512, 512), mode='bilinear', align_corners=True)
